// Since react-native-udp acts as a RN compatible port of dgram, this type decl. has been copied from dgram
declare module 'react-native-udp' {
  ...
  class Socket extends events.EventEmitter {
      ...
      address(): AddressInfo;
      bind(port?: number, address?: string, callback?: (err: Error) => void): void;
      bind(port?: number, callback?: (err: Error) => void): void;
      bind(callback?: (err: Error) => void): void;
      bind(options: BindOptions, callback?: (err: Error) => void): void;
